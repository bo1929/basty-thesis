...
\section{Quantifying Activities}\label{section:quantifying-activities}
\subsection{Dormancy and Macro-activity Epochs}\label{section:dormancy-and-macroactivity}
