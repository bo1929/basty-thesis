...
Such behaviors are potentially related to behaviorally defined states of sleep similar to REM sleep (rapid eye movement sleep) phase observed in mammals and birds.
Results demonstrates that our pipeline robustly detects activities, and successfully maps behavioral categories.
Overall, \texttt{basty} achieves a macro average of 0.8 AUC score.
Moreover, we demonstrate its ability of detecting unobserved behaviors and differences between behavioral repertoires.
