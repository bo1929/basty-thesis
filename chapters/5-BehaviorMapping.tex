...
As described in Section~\ref{section:nearest-neighbors-analysis}, semi-supervised pair embeddings are utilized to predict behavioral categories of unannotated experiments by combining multiple view acquired from annotated ones.
