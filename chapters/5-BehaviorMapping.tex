...
\NOTE{
	...
	For example, 0.7 \Grooming, 0.3 \ProboscisPumping may indicate that those two behaviors are simultaneously exhibited or a combination of both is exhibited etc.
