...
For example, \citet{itskov_automated_2014} presents a method which utilizes capacitive measurements, for automated quantification of feeding behavior.
Another such an ad-hoc solution is developed by \citet{qiao_automated_2018}, and achieves automated analysis of long-term grooming behavior in \textit{Drosophila Melanogaster}.
...
Another such example is switch-like behavior of the haltere which is characterized by haltere's positional change in the order of microns, and eventuate rapidly within a second.
...
% Automated quantification of switch-like movement of haltere is achieved for the first time in this work.
