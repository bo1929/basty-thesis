...
\chapter{Activity Detection}\label{chapter:activity-detection}
...
Configuration and the parameters of the random forest ensemble of decision trees is given in Section~\ref{section:employing-proposed-pipeline}, and its performance is evaluated and compared with the unsupervised approach in the same section as well.
