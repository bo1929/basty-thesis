...
Configuration and the parameters of the random forest ensemble of decision trees are given in Section~\ref{section:employing-proposed-pipeline}, and its performance is evaluated and compared with the unsupervised approach in Section~\ref{section:performance-evaluation}.
