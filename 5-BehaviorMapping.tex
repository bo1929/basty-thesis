...
\NOTE{Describe approaches and use cases.}
\NOTE{Discuss predicted and annotated $\MicroActivity$ sets.}
\NOTE{Summarize mapping.}
\NOTE{Introduce sections.}
...
Although we use a proper metric, e.g., Hellinger distance, defining the distance between a set of points, one can also define a simple metric for categorical values to extend UMAP further for supervised and semi-supervised cases.
...
\begin{figure}[htb!]
	...
	\end{subfigure}%
	\caption[Supervised and unsupervised embeddings of FlyF15-08182021173222.]{Two dimensional supervised and unsupervised behavioral embeddings of FlyF15-08182021173222. Both embeddings reveals variations within annotated behavioral categories.}
\end{figure}
