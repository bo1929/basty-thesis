...
In this approach, namely semi-supervised pair embeddings,	we compute an joint behavioral space for each annotated and unannotated pair, using the available annotations.
...
When the behavioral repertoire and/or feature distribution are dissimilar, resulting embedding may not provide useful information about the unannotated experiment, but an advantage of this approach is that the other pair embeddings do not get distorted by poor matches.
