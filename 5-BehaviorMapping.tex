...
Considering such constraints and temporal expectations, we apply following post-processing procedures, and parameters should be determined based on the behavioral repertoire of interest.
