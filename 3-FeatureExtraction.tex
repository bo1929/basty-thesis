...
\begin{align}
	...
	\V{M}_\mu    & = \rbr{\mu_\tau\rbr{g_{i,t}}}_{1\leq t \leq T, \, \tau \in \mathcal{T}_G, \, 1 \leq i \leq  N_G},           \\
	\V{M}_\sigma & = \rbr{\sigma_\tau\rbr{g_{i,t}}}_{1\leq t \leq T, \, \tau \in \mathcal{T}_G, 1 \leq i \leq N_G}.
\end{align}
...
Here $\V{\hat{W}}$, $\V{\hat{M}}_\mu$ and $\V{\hat{M}}_\sigma$ are the final multivariate time series of normalized high dimensional behavioral representation of a single experiment data, i.e., single fruit fly recorded between ZT10 and ZT2.
Notice that, we may treat each time step, i.e., frame, as a discrete probability distribution after $\textnormal{L}_1$ normalization.
