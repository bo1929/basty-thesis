...
\begin{figure}[ht!]
	...
	\caption[Binned temporal heatmap of activities.]{Binned temporal heatmap of activities.
		...
		Activity value is computed as the ratio of number of annotated frames and total number of frames in the bin.}
\end{figure}
...
\begin{figure}[ht!]
	...
	\begin{subfigure}[b]{0.45\linewidth}
		...
		\caption{Fraction of time spent with micro-activities in dormant epochs.}
	\end{subfigure}%
